...
static __always_inline u64 native_rdmsrq(const u32 msr)
{
	return __rdmsr(msr);
}
...
static __always_inline void native_wrmsrq(const u32 msr, const u64 val)
{
...
static __always_inline void wrmsrq(const u32 msr, const u64 val)
{
...
static __always_inline int wrmsrq_safe(const u32 msr, const u64 val)
{
...
static inline void wrmsr(const u32 msr, const u32 low, const u32 high)
{
...
static inline void wrmsrq(const u32 msr, const u64 val)
{
	native_write_msr(msr, val);
}

/* wrmsr with exception handling */
static inline int wrmsrq_safe(const u32 msr, const u64 val)
{
